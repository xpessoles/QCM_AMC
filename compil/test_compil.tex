...
\input{../Banque_Info/01_OperationsElementaires}
\input{../Banque_Info/02_OperationsArithmetiques}
\input{../Banque_Info/03_Fonctions}
\input{../Banque_Info/04_CodageEntiers}
\input{../Banque_Info/05_CodageEntiersRelatifs}
\input{../Banque_Info/06_CodageHexa}
\input{../Banque_Info/07_AlgebreBoole}
\input{../Banque_Info/08_ChainesCaracteres}
\input{../Banque_Info/09_StructuresTantQue}
\input{../Banque_Info/10_StructuresConditionnelles}
\input{../Banque_Info/11_StructuresFor}
\input{../Banque_Info/12_Listes}
\input{../Banque_Info/13_FonctionsEtListes}
\input{../Banque_Info/14_ListesComprehension}
