...
\begin{multicols}{4}
	...
	\bonne{7,5\degres}
	\mauvaise{15\degres}
	\mauvaise{0,75 \degres}
	\mauvaise{3,75 \degres}
	\end{reponses}
	\end{multicols}
\end{question}\\
}
...
\begin{multicols}{4}
	\begin{reponses}	
	\bonne{0,234\degres}
	\mauvaise{0,47\degres}
	\mauvaise{0,93 \degres}
	\mauvaise{540\degres}
	\end{reponses}
	\end{multicols}
\end{question}\\
...
\begin{multicols}{4}
	\begin{reponses}	
	\bonne{0,18\degres}
	\mauvaise{0,36\degres}
	\mauvaise{0,09\degres}
	\mauvaise{1\degres}
	\end{reponses}
\end{multicols}
\end{question}\\}
...
\begin{multicols}{4}
	\begin{reponses}	
	\bonne{0,011\degres}
	\mauvaise{0,022\degres}
	\mauvaise{0,044\degres}
	\mauvaise{0,0055\degres}
	\end{reponses}
\end{multicols}
